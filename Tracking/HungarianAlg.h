...
/*!
 * @ingroup     AssignmentProblemSolver
 * @class       AssignmentProblemSolver   defines.h
 * @brief      ce module permet de résoudre le problème d'affectation en utilisant hungarian algorithme
 */
class AssignmentProblemSolver
{
private:

    /*! @brief calcule l'affectation optimale (Coûts globaux minimaux)
     *
     */
	...
	void step4(assignments_t& assignment, track_t *distMatrix, bool *starMatrix, bool *newStarMatrix, bool *primeMatrix, bool *coveredColumns, bool *coveredRows, size_t nOfRows, size_t nOfColumns, size_t minDim, size_t row, size_t col);
     ...
     /*! @brief Calcule une solution sous-optimale. Bon pour les cas avec de nombreuses tâches interdites.
      */
